...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrive_recipes(self):
        ...
        recipes = Recipe.objects.all().order_by("-id")  # decending order
        serializer = RecipeSerializer(
            recipes, many=True
        )  # Serializer should handler a collection of objects instead of a single object
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email="user2@example", password="newpass123")
        recipe = create_recipe(user=self.user)
    ...
    def test_create_ingredient_on_update(self):
        """Test creasting an ingredient when updating a recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        res = self.client.get(RECIPES_URL, params)  # type: ignore
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        ...
        # tempfile.NamedTemporaryFile is used to create a temporary file
        # it is a python internal module
