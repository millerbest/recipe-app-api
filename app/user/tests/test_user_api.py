...
CREATE_USER_URL = reverse("user:create")  # full url for creating a user
...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_success(self):
        ...
        # Security check (password should not shown in the response)
    ...
    def test_create_otken_bad_credentials(self):
